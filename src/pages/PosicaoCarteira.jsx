...
import WhaleTransactionsTable from '../components/portfolio/WhaleTransactionsTable';
import MarketAnalysisTable from '../components/portfolio/MarketAnalysisTable';
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <WhaleTransactionsTable data={whaleData} />
        </CardContent>
      </Card>
