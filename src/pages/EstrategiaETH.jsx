...
const EstrategiaETH = () => {
  ...
  const mappedConditionsStatus = conditionsStatus ? {
    ...
    currentPrice: conditionsStatus.currentPrice,
    ema50Value: conditionsStatus.trend?.ema50,
    adx: conditionsStatus.dmi?.adx || conditionsStatus.adx || 0,
    atrValue: 0,
    avgVolume: conditionsStatus.avgVolume,
    currentVolume: conditionsStatus.currentVolume,
    referenceHigh: conditionsStatus.referenceCandle?.high,
    referenceLow: conditionsStatus.referenceCandle?.low,
    fibonacci: null,
    rrRatio: 0,
    direction: signalStatus !== 'wait' ? signalStatus : null,
    rsi: conditionsStatus.rsi?.value,
    macdValue: conditionsStatus.macd?.histogram,
    obvValue: 0,
    obvTrend: conditionsStatus.macd?.bullish ? 'up' : 'down',
    marketStrength: conditionsStatus.marketStrength,
    volumeProfile: 0,
    swingHigh: null,
    swingLow: null,
    legSize: null,
